...
import {
    CreateHostRoomInput,
    CreateHostRoomMutation,
    DeleteHostRoomInput,
    DeleteHostRoomMutation,
    DeleteHostRoomUserInput,
    DeleteHostRoomUserMutation,
    HostRoom,
    HostRoomUser,
    ListHostRoomsQuery,
    ListHostRoomUsersQuery,
    ModelHostRoomFilterInput,
    ModelHostRoomUserFilterInput,
    UpdateHostRoomInput,
    UpdateHostRoomMutation
} from '../API'

export class HostApi {
    public createHostRoom = async (
    ...
    public getUserCreatedHostRooms = async (
        userId: string
    ): Promise<HostRoom[]> => {
    ...
    public getHostRoomUsers = async (
        roomId: string
    ): Promise<HostRoomUser[]> => {
