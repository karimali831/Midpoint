    ...
    return (
        ...
        >
            <div className="connected-midi-container">
                <span className="connected-midi-title">Linked MIDI device</span>
                <span className="connected-midi-sub">
                    Don't see your MIDI device? Continue on and set yours in the
                    lobby.
                </span>
                ...
                <div className="connected-midi-action-btn">
                    ...
                    <MainButton
                        onClick={() =>
                            dispatch(
                                SetMidPointStep(MidPointStep.SoftwareSelect)
                            )
                        }
                        text="Continue"
