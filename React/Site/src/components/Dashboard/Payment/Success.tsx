...
import { EmptyBasketAction } from '../../../state/contexts/checkout/Actions'
...
export const PaymentSuccess = () => {
    ...
    return (
        ...
        >
            <span style={{ fontSize: 34 }}>Payment successful</span>
            ...
            >
                Tokens are usually added immediately but there maybe a short
                delay for up to 10 minutes before <br />
                purchased tokens appear in your account. If tokens don't appear
                after 30 minutes please contact support.
            </div>
            <MainButton
                onClick={() =>
