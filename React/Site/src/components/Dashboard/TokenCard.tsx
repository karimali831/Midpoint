...
import { AddToBasketAction } from '../../state/contexts/checkout/Actions'
...
export const TokenCard: React.FC<IOwnProps> = (props) => {
    ...
    const buy = () => {
        ...
        dispatch(AddToBasketAction(pricePlan))
    ...
    return (
        ...
        >
            {!pricePlan ? (
                ...
                >
                    <span style={{ fontSize: 20 }}>Custom package?</span>
                    <div
                        style={{
                            background: '#195DC4',
                            borderRadius: 19.5,
                    ...
                    >
                        ...
                        >
                            ...
                            {pricePlan.percentageSaving > 0 && (
                                ...
                                >
                                    <span>
                                        Save {pricePlan.percentageSaving}%
                                    </span>
                                </div>
                            )}
                        </div>
