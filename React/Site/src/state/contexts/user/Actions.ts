...
const GetPromotionsFailureAction = createAction<string>(
    '@@User/GetPromotionsFailure'
)
...
const GetPaymentsFailureAction = createAction<string>(
    '@@Checkout/GetPaymentsFailure'
)
