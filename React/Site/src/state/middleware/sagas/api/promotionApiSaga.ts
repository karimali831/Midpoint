...
import { GetPromotionsAction, GetPromotionsSuccessAction } from '../../../contexts/user/Actions';
...
export function* getPromotions() {
    ...
    const response : IPromotion[] = yield call(promotionApi.getPromotions, user.id)
